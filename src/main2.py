...
class DifferenceCoinBlockchain:
    ...
    def resolve_conflicts(self):
        ...
        print(f"\n=== Starting Consensus Process on Node 2 ===")
    ...
    def save_chain(self):
        with open('differencecoin2.json', 'w') as f:
            json.dump(self.chain, f, indent=4)

    def load_chain(self):
        try:
            with open('differencecoin2.json', 'r') as f:
